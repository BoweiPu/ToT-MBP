...
my_epochs = {
    'DescribableTextures': (700,2000,100),
    'EuroSAT': (0,500,20),
    'FGVCAircraft': (1000,1500,50),
    'Food101': (700,2000,100),
    'OxfordFlowers': (500,2000,100),
    'SUN397': (500,2000,100),
    'UCF101': (500,1500,100),
    'ImageNetR': (1000,2000,100),
}
my_epochs0 = {
    'DescribableTextures': (800,2000,50),
    'EuroSAT': (150,400,20),
    'FGVCAircraft': (400,1300,50),
    'Food101': (500,2000,100),
    'OxfordFlowers': (700,1600,50),
    'SUN397': (1000,2000,100),
    'UCF101': (400,1300,100),
    'ImageNetR': (1000,2000,100),
}
my_epochs1 = {
    'DescribableTextures': (1000,2000,50),
    'EuroSAT': (100,500,20),
    'FGVCAircraft': (400,1300,50),
    'Food101': (700,2000,100),
    'OxfordFlowers': (1000,2000,50),
    'SUN397': (500,2000,100),
    'UCF101': (500,1500,100),
    'ImageNetR': (1000,2000,100),
}
text_cls_top = {
    'DescribableTextures':(25,300) ,
    'EuroSAT': (25,300),
    'FGVCAircraft': (25,300),
    'Food101': (25,300),
    'OxfordFlowers': (25,300),
    'SUN397': (25,300),
    'UCF101': (25,300),
    'ImageNetR': (25,300),
}
text_cls_lr = {
    'DescribableTextures': 0.0001,
    'EuroSAT': 0.0001,
    'FGVCAircraft': 0.0001,
    'Food101': 0.001,
    'OxfordFlowers': 0.0001,
    'SUN397': 0.0001,
    'UCF101': 0.0001,
    'ImageNetR': 0.0001,
}

def setup_lr(args, dataset):
    args.lr = text_cls_lr[dataset]
def setup_txt_epochs(args, dataset):
    args.txt_epochs = text_cls_epochs[dataset]
def setup_my_epochs(args, dataset):
    args.txt_epochs = my_epochs0[dataset]
def setup_my_epochs1(args, dataset):
    args.txt_epochs = my_epochs1[dataset]
def get_env_id():
...
def zero_shot(model, loader):
    ...
    print(f"epoch0 ,Accuracy: {top1:.2f}")
